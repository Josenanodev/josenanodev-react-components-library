...
import { draggingOverDateCellsSelector } from "../redux/state/features/Dates/DateReducer";
import {
  languageSelector,
  lookAndFeelSelector,
} from "../redux/state/features/AppSettings/AppSettingsReducer";

//Assets
import * as BootstrapIcons from "react-icons/bs";

//Componentes
import DatesRow from "../components/individuals/DatesRow/DatesRow";
import ListElementsColumn from "../components/composites/ListElementsColumn/ListElementsColumn";
import DatesGrid from "../components/composites/DatesGrid/DatesGrid";
import DropdownNavegadorMeses from "../components/individuals/DropdownMonthNavigation/DropdownMonthNavigation";
...
//Types
import { MultidestinyPropsType, RenderCoordinatesType } from "./types";

//Services
import {
  eraseMultidestinyYScrollPosition,
  getMultidestinyYScrollPosition,
} from "../Services/MultidestinyStatesAndSettings";
...
const Multicalendar = ({
  ...
  const draggingOverDateCells = useSelector(draggingOverDateCellsSelector);
  //Refs
  ...
  useEffect(() => {
    ...
    if (!firtsCall) {
      setFirtsCall(true);
      //Cached Y position
      let newYPosition = getMultidestinyYScrollPosition();
  ...
  return (
    ...
    >
      ...
      <div className="filtros-logo">
        {lookAndFeel?.logoUrl && (
          <img className="logo" src={lookAndFeel?.logoUrl} alt="logo" />
        )}
      </div>
      ...
      <div className="div-contenedor-principal">
        <div
          ...
          onScroll={(e) => {
            ...
            if ((e.target as HTMLDivElement).scrollLeft < cellsWidth) {
